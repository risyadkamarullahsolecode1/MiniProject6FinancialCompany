...
namespace MiniProject6.Infrastructure.Migrations
{
    ...
    [Migration("20241126131954_updatetable1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.Department", b =>
                {
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.Dependent", b =>
                {
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.Employee", b =>
                {
                    b.Property<int>("Empno")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MiniProject6.Domain.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasOne("MiniProject6.Domain.Entities.Employee", "SpvempnoNavigation")
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.Dependent", b =>
                {
                    b.HasOne("MiniProject6.Domain.Entities.Employee", "EmpnoNavigation")
                        .WithMany("Dependents")
                        .HasForeignKey("Empno")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.Employee", b =>
                {
                    b.HasOne("MiniProject6.Domain.Entities.Department", "DeptnoNavigation")
                        .WithMany("Employees")
                        .HasForeignKey("Deptno")
                        .HasConstraintName("fk_deptno");

                    b.HasOne("MiniProject6.Domain.Entities.AppUser", "AppUser")
                        .WithMany("Employees")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("MiniProject6.Domain.Entities.Workson", b =>
                {
                    ...
                    b.HasOne("MiniProject6.Domain.Entities.Project", "ProjnoNavigation")
                        .WithMany("Worksons")
